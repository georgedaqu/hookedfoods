$(document).ready(function(){
	...
	$(document).click(function(e){
		if(!$(e.target).closest("section.reciepes_filter div.filter_items div.form_item").length > 0){
			// Function
			$("section.reciepes_filter div.filter_items div.form_item").removeClass("active");
		}
	});
	// Share popup
